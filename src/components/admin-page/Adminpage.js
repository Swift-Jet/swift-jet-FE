...
import logoprimary from "../admin-page/logoprimary.png";
import adminimage from "../admin-page/admin.jpg"
        ...
        <aside class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between shadow bg-white px-6 pb-3 transition duration-300 md:w-6/12 lg:ml-0 lg:w-[35%] xl:w-[30%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-200" >
          <div>
            <div class="-mx-6 px-6 py-4">
              <a href="#" title="home">
                <img src={logoprimary} class="w-32" alt="tailus logo" />
              </a>
            </div>
      
            <div class="mt-8 text-center">
              <img src={adminimage} alt="" class="m-auto h-10 w-10 rounded-full object-cover lg:h-28 lg:w-28"/>
              <h5 class="mt-4 hidden text-xl font-semibold text-gray-600 lg:block dark:text-gray-300">Cynthia J. Watts</h5>
              <span class="hidden text-gray-400 lg:block">Admin</span>
            </div>
       <ul class="mt-8 space-y-2 tracking-wide">
              <li>
                <a href="#" aria-label="dashboard" class="relative flex items-center space-x-4 rounded-xl bg-rose-900 px-4 py-3 text-white">
                  <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z"
                      class="dark:fill-slate-600 fill-current text-rose-900"></path>
                    <path d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z" class="fill-current text-cyan-200 group-hover:text-rose-900"></path>
                    <path d="M13 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-1Z"  class="fill-current group-hover:text-rose-900"></path>
                  </svg>
              ...
              <li>
                ...
                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M121 936v-60h720v60H121Zm63-208L81 553l43-8 70 62 226-61-171-287 58-17 285 257 216-58q27-8 49 9.5t22 46.5q0 19-11.5 34T838 551L184 728Z"/></svg>
                  <span class="group-hover:text-gray-700 dark:group-hover:text-gray-50">Flights</span>
                </a>
              </li>
              <li>
                <a href="#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300">
          ...
          <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4 dark:border-gray-200">
          ...
          <div class="px-6 pt-6 2xl:container">
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div class="md:col-span-2 lg:col-span-1">
                <div class="h-full space-y-6 group shadow p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                  <svg
                  ...
                  <div>
                    <h5 class="text-center text-xl text-gray-600 dark:text-gray-300">Performance</h5>
                    <div class="mt-2 flex justify-center gap-4">
                      <h3 class="text-3xl font-bold text-gray-700 dark:text-rose-900">988</h3>
                    ...
                    <span class="block text-center text-gray-500 dark:text-gray-400">Compared to last week 588</span>
                  </div>
                  <table class="w-full text-gray-600 dark:text-gray-200">
                    <tbody>
                      <tr>
                        <td class="py-2">Completed Flight</td>
              ...
              <div>
                <div class="h-full group p-6 sm:p-8 shadow rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
              ...
              <div>
                <div class="group p-6 sm:p-8 shadow rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
                  <svg
                    class="m-auto w-40"
                    viewBox="0 0 56 56"
                    fill="none"
