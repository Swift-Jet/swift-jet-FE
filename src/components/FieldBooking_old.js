  ...
  return (
    <>
      ...
      <div className="relative flex h-96  content-center items-center justify-center pb-32 pt-16">
        <div className="absolute top-0 h-96 w-full  bg-cover bg-center" />

        <div className="absolute top-0 h-full w-full bg-cover bg-center" />
        <div className="max-w-8xl container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto mt-16 w-full px-4 pb-8 pt-8 text-center lg:w-8/12">
              {/* <Typography variant="h2" color="white" className="font-black">
                The easiest way to travel anywhere
              </Typography> */}
            </div>
          </div>
        </div>
      ...
      <div className="row mb-12 booking-engine ">
            ...
            {bookingArr && bookingArr.length > 0 ? (
              <div>
                <div className="w-full">
                  {" "}
                  <div class="row pr-8 pl-8 2xl:w-4/5 xl:w-4/5 m-auto sm:w-full sm:pl-0 sm:pr-0 list-trips overflow-auto">
                    {bookingArr.map((data, i) => {
                      return (
                        <div className=" flex flex-col p-3 rounded-xl display-trip ">
                          <div className=" flex flex-row justify-between align-center">
                            <p></p>
                            <button
                              className="remove-skill text-white"
                              onClick={() => {
                                setBookingArr(
                                  JSON.parse(
                          ...
                          <div class="flex justify-between items-center  ">
                            ...
                            <div class="flex items-center">
                              <svg
                                className="svg-icon h-6 w-6 text-white fill-current "
                          ...
                          <div class="flex justify-between items-center text-white">
                            <div class="flex items-center">
                              <svg
                                className="svg-icon h-5 w-5 text-white fill-current mr-2"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 96 960 960"
                              >
                    ...
                    <div className="justify-end flex">
                      <button
                        className="bg-[#5c0632] text-white active:bg-emerald-600 font-bold text-sm px-3 py-2 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        onClick={() => {
                          setShowModal(false);
              ...
              >
                <div>
                  <Avatar
                    src="https://assets.radical.storage/luggage-storage/boston/350x200.5347.webp"
                    alt=""
                    size="xxl"
        ...
        <div className="col-sm-6 first-stn-left-div">
          <div className="first-stn-left ">
            <form class="w-full max-w-lg m-auto pt-4 pb-4 first-stn-left-inner">
      ...
      {loading === true ? (
        ...
        <div className="w-full text-left font-Aeonik text-rgba(77,77,77,1) field-booking pt-12">
          ...
          <div className="bg-white">
            <div className="w-1/2 mr-auto ml-auto text-center">
              <h3 className=" text-[2em] pt-12">Destinations</h3>
            ...
            <div className="mt-24 grid grid-cols-1 gap-12 gap-x-24 md:grid-cols-2 xl:grid-cols-4 ml-auto mr-auto w-10/12">
          ...
          <div className="2xl:grid-cols-4 2xl:grid xl:grid-cols-4 xl:grid lg:grid-cols-4 lg:grid md:grid-cols-2 md:grid pt-24 justify-center md:flex w-10/12 mr-auto ml-auto">
            {aircrafts.slice(0, 4).map((data, i) => (
