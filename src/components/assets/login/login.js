                            ...
                            <form action="" class="space-y-8">
                                <div class="space-y-2">
                                    ...
                                    <input
                                        ...
                                        class="focus:outline-none block w-full rounded-md border border-gray-200 dark:border-gray-600 bg-transparent px-4 py-3 text-rose-900 transition duration-300 invalid:ring-2 invalid:ring-red-400 focus:ring-2 focus:ring-cyan-300"
                                    />
                                </div>
