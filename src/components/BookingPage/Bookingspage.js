...
const Bookingspage = () => {
    ...
    return (
        ...
        <div className="mx-auto font-[Poppins]  bg-[#eeece1]">
            ...
            <section className="bg-rose-900">
                <div className="flex flex-col justify-between sm:flex-row">
                    <div className="px-24 m-3 text-xs text-white md:text-xl lg:text-xl lg:">
                      Thank You Wasiu Tiamiyu
                    </div>
            ...
            <section className="">
            <div className="px-28 mt-3 text-xs md:text-sm lg:text-xl">
                <p className="text-rose-900 text-xl"> Flight Details </p>
                <p className="text-black mt-2 ">Please find your flight and booking information below </p>
            </div>
                <BookingCards />
            </section>
        </div>
