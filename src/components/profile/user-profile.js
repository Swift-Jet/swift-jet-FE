            ...
            <div class="bg-white">
                ...
                <div class="container mx-auto max-w-3xl mt-8">
                    ...
                    <ul class="flex border-b border-gray-300 text-sm font-medium text-gray-600 px-6 md:px-0">
                        <li class="mr-8 text-gray-900 border-b-2 border-[#5C0632] "><a href="#_" class="py-4 inline-block">Profile Info</a></li>
                        <li class="mr-8 hover:text-gray-900"><a href="#_" class="py-4 inline-block">Recent Trips</a></li>
                        <li class="mr-8 hover:text-gray-900"><a href="#_" class="py-4 inline-block">Settings</a></li>
                    </ul>
                    <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">

                        <div class="w-full bg-[#eeece1]  rounded-lg mx-auto  flex overflow-hidden rounded-b-none">
                            ...
                            <div class="md:w-2/3 w-full">
                                ...
                                <div class="py-8 px-16 clearfix">
                                    ...
                                    <div class="bg-[#5C0632] text-white text-xs mt-5 ml-3 font-bold px-4 py-2 rounded-lg float-left hover:bg-[#5C0632] hover:text-white relative overflow-hidden cursor-pointer">
