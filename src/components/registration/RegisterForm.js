      ...
      <div class="relative xl:container m-auto px-6 text-gray-500 md:px-12">
        <div class="m-auto space-y-8 sm:w-4/5 md:w-3/5 xl:w-2/5">
          <div class="p-8 md:py-12 ">
            ...
            <h2 class="mt-20 mb-8 text-3xl font-bold text-gray-800 dark:text-white">Welcome to SwiftJet.</h2>
            <form action="" class="space-y-8 ">
            <div class="space-y-4">
                <label for="username" class="text-gray-600 dark:text-gray-300">Full name </label>
              ...
              <div class="space-y-4">
                ...
                <span class="relative text-base font-semibold text-white dark:text-dark">Register </span>
                </Button>
