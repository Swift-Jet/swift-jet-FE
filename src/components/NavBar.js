                                    ...
                                    <ul class="gap-y-6 tracking-wide text-gray-500 dark:text-gray-300 font-medium flex flex-col md:flex-row md:gap-y-0">
                                        <li>
                                            <a href="#" class="block md:px-8">
                                                <div class="relative text-rose-900 dark:text-rose-900
                                                    ...
                                                    <span className="lg:text-sm">Home</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="block md:px-4 group">
                                                <div class="relative group
                                                    ...
                                                    <span class="group-hover:text-rose-900 lg:text-sm ">About Us</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="block md:px-4 group">
                                                <div class="relative group
                                                            before:absolute before:-bottom-2 md:before:-bottom-3 before:w-full before:h-0.5 before:origin-left before:mt-auto before:rounded-full before:bg-rose-800 before:transition before:scale-x-0 group-hover:before:scale-x-100">
                                                    <span class="group-hover:text-rose-900 lg:text-sm">Fleet</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="block md:px-4 group">
                                                <div class="relative group
                                                            before:absolute before:-bottom-2 md:before:-bottom-3 before:w-full before:h-0.5 before:origin-left before:mt-auto before:rounded-full before:bg-rose-800 before:transition before:scale-x-0 group-hover:before:scale-x-100">
                                                    <span class="group-hover:text-rose-900 lg:text-sm">Services</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="block md:px-4 group">
                                                <div class="relative group
                                                            before:absolute before:-bottom-2 md:before:-bottom-3 before:w-full before:h-0.5 before:origin-left before:mt-auto before:rounded-full before:bg-rose-800 before:transition before:scale-x-0 group-hover:before:scale-x-100">
                                                    <span class="group-hover:text-rose-900 lg:text-sm">Contact</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
