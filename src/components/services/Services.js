...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
    <div class=" xl:max-w-6xl mx-auto px-4">
        ...
        <div class="flex flex-wrap flex-row -mx-4 text-center">
            <div class="flex-shrink px-4 max-w-full w-full sm:w-full md:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s">
            ...
            <div class="flex-shrink px-4 max-w-full w-full sm:w-full md:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >
            ...
            <div class="flex-shrink px-4 max-w-full w-full sm:w-full md:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" >
