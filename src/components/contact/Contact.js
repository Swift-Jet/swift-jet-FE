...
const Contact = () => {
  ...
  const data = { email, name, number, enquiry }
  const handleSubmit = (e) => {
    setLoading(true);
    e.preventDefault();
    axios
      .post(`https://swift-jet-backend-staging.onrender.com/api/v1/enquiry/add`, data)
      .then((data) => {
        console.log(data);
            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                  <span class="text-[#961054] mb-4 block text-base font-semibold">
                    Contact Us
                  </span>
                  <h2
                    class="text-dark mb-6 text-[20px] font-bold uppercase sm:text-[20px] lg:text-[26px] xl:text-[30px]"
                  >
                    GET IN TOUCH WITH US
                  </h2>
                  <p class="text-body-color mb-9 text-base leading-relaxed">
                    If you have any question or comments regarding SwiftWings, the portal or job mobility in general, you are welcome to contact our helpdesk.
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div
                      class="bg-[#961054] text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                    >
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        class="fill-current contact-icon"
                      >
                        <path
                    ...
                    <div class="w-full">
                      <h4 class="text-dark mb-1 text-sm font-bold">Our Location</h4>
                      <p class="text-body-color text-base">
                        Swift Jets Building, Lagos
                      </p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      <h4 class="text-dark mb-1 text-sm font-bold">Phone Number</h4>
                      <p class="text-body-color text-base">(234)902 8792 910</p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div
                    ...
                    <div class="w-full">
                      <h4 class="text-dark mb-1 text-sm font-bold">Email Address</h4>
                      <p class="text-body-color text-base">charter@swiftwingsjet.com</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <form action=''>
                    ...
                    <div class="mb-6">
                      <textarea
                        ...
                        rows="8"
                        placeholder="Enquiry"
                        class="text-body-color text-xs border-[f0f0f0] focus:border-[#961054] w-full contact-input resize-none rounded border p-2.5 text-base outline-none focus-visible:shadow-none"
                      ></textarea>
                    </div>
                    <div>
                      <button
                        ...
                        class="bg-[#961054] border-[#961054] w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                  ...
                  <div>
                    <span class="absolute -top-10 -right-9 z-[-1]">
                      <svg
                        width="100"
                        height="100"
                        className="fill-current contact-icon"
                        viewBox="0 0 100 100"
                        fill="none"
